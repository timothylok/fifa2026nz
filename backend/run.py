...
from src.poisson import lambda_from_elo, match_probs
from src.simulate import FIFA_2026_GROUPS, run_simulations


def build_group_match_probs(ratings: dict) -> list[dict]:
    rows = []
...
def main() -> None:
    ...
    win_counts = run_simulations(ratings, n=args.sims, n_jobs=args.jobs)

    print("Computing group match probabilities ...")
    gmp = build_group_match_probs(ratings)
